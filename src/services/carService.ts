...
function normalizeCarData(raw: any): Car {
  ...
  return {
    ...
    images: raw.images ? normalizeImages(raw.images) : [],
    userId: Number(raw.user_id || raw.userId || 0),
    userName: raw.user_name || raw.username || 'Usuario',
    userEmail: raw.user_email || '',
    approved: Boolean(raw.approved ?? raw.is_approved ?? false),
    ...
    fuelType: technical.fuelType || raw.fuelType || '',
    transmission: technical.transmission || raw.transmission || '',
    engine: technical.engine || raw.engine || '',
    color: technical.color || raw.color || '',
    doors: Number(technical.doors || raw.doors || 4),
    bodyType: technical.bodyType || raw.bodyType || '',
    features: technical.features || [],
    issues: technical.issues || [],
    paymentMethods: technical.paymentMethods || [],
    warranty: technical.warranty || false,
    warrantyDetails: technical.warrantyDetails || ''
  };
}
